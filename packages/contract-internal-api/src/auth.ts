...
/**
 * HTTP header schema for Cognito context data
 *
 * @see https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_HttpHeader.html
 */
export const CognitoContextHttpHeaderSchema = z.object({
  headerName: z.string().optional(),
  headerValue: z.string().optional(),
});

export type CognitoContextHttpHeader = z.infer<
  typeof CognitoContextHttpHeaderSchema
>;

/**
 * Contextual user data for Cognito adaptive authentication (threat protection)
 *
 * This data is collected from the client and passed through to Cognito
 * to evaluate the risk of an authentication event.
 *
 * @see https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_ContextDataType.html
 */
export const CognitoContextDataSchema = z.object({
  /**
   * The HTTP headers from your user's authentication request
   */
  HttpHeaders: z.array(CognitoContextHttpHeaderSchema),
  /**
  ...
  ServerPath: z.string(),
  /**
   * Encoded device-fingerprint details collected with the Amazon Cognito context data collection library
   * Generated by: AmazonCognitoAdvancedSecurityData.getData(username, userPoolId, clientId)
   *
...
export type CognitoContextData = z.infer<typeof CognitoContextDataSchema>;
...
export const initiateMagicLink = oc
  ...
  .input(
    z.object({
      ...
      alreadyHaveMagicLink: z.boolean().optional(),
      contextData: CognitoContextDataSchema.optional(),
    })
  )
  .output(
    z.object({
