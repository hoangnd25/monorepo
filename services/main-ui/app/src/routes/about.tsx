        ...
        <Stack gap={8}>
          ...
          <VStack align="start" gap={3}>
            ...
            <Text color="gray.600" fontSize="lg">
              A comprehensive showcase of Chakra UI v3 components in TanStack
              Start
            </Text>
          </VStack>
          ...
          <Box>
            ...
            <Accordion.Root collapsible defaultValue={['faq-1']}>
              <Accordion.Item value="faq-1">
                ...
                <Accordion.ItemContent>
                  <Accordion.ItemBody>
                    ...
                    library that gives you the building blocks to build React
                    applications with speed. It follows WAI-ARIA standards and
              ...
              <Accordion.Item value="faq-2">
                ...
                <Accordion.ItemContent>
                  <Accordion.ItemBody>
                    ...
                    component composition pattern. It&apos;s built for modern
                    React applications and works seamlessly with server-side
                    rendering.
                  </Accordion.ItemBody>
                </Accordion.ItemContent>
              </Accordion.Item>
              ...
              <Accordion.Item value="faq-3">
                <Accordion.ItemTrigger>
                  <Span flex="1">
                    How does it integrate with TanStack Start?
                  </Span>
                  <Accordion.ItemIndicator />
                </Accordion.ItemTrigger>
                <Accordion.ItemContent>
                  <Accordion.ItemBody>
                    Chakra UI integrates perfectly with TanStack Start through
                    the ChakraProvider wrapper. All components support
                    server-side rendering out of the box, making it ideal for
                    full-stack React applications that need both performance and
                    beautiful UI.
                  </Accordion.ItemBody>
                </Accordion.ItemContent>
              </Accordion.Item>
              ...
              <Accordion.Item value="faq-4">
                ...
                <Accordion.ItemContent>
                  <Accordion.ItemBody>
                    Yes! Chakra UI v3 is production-ready and used by thousands
                    of companies worldwide. It has comprehensive documentation,
                    active community support, and regular updates to ensure
          ...
          <Box pt={4}>
            <Text color="gray.500" fontSize="sm">
              This page demonstrates various Chakra UI components including
              Avatars, Tabs, Accordions, Progress bars, and more. Check out the{' '}
